...
class Data_Loader:
    ...
    def get_dataset1(self, dataset_name, c_percent=None, true_label=1):
    ...
    def load_data_CIFAR10(self, true_label):
        ...
        return x_train, x_test, test_labels, class_name
    ...
    def load_data_CIFAR10_myStyle(self, true_label):
        ...
        train_data = np.array(trainset.data)
        train_labels = np.array(trainset.targets)
        train_data = train_data[np.where(train_labels == true_label)]   # target normal 데이터만 사용
